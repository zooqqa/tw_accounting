...
- [ ] Создание структуры проекта с микросервисной архитектурой
- [ ] Настройка Docker Compose для всех сервисов
- [ ] Настройка баз данных: PostgreSQL + TimescaleDB
- [ ] Настройка Redis для кэширования и очередей
- [ ] Настройка CI/CD pipeline

#### 1.2 Общие компоненты
- [ ] Создание API Gateway
- [ ] Настройка FastAPI-Users для аутентификации
- [ ] Создание модели User с ролями
- [ ] Настройка JWT токенов и refresh механизма
